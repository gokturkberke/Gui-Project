...
class TransactionViewer(tk.Toplevel):
    ...
    def init_ui(self):
        ...
        self.edit_button = tk.Button(self.button_frame, text=self.get_translation("edit"), command=self.edit_transaction)
        self.edit_button.pack(side=tk.LEFT, padx=5)

        self.delete_button = tk.Button(self.button_frame, text=self.get_translation("delete"), command=self.delete_transaction)
    ...
    def refresh_ui(self):
        ...
        self.edit_button.config(text=self.get_translation("edit"))
...
class EditTransactionWindow(tk.Toplevel):
    def __init__(self, master, viewmodel, transaction_values):
        ...
        self.title(self.get_translation("edit_transaction"))
        self.geometry("400x350")
        self.init_ui()

    def init_ui(self):
        self.label = tk.Label(self, text=self.get_translation("edit_transaction"), font=("Arial", 16))
        ...
        fields = [
            ...
            (self.get_translation("type"), self.type_var),
        ]
        self.field_widgets = []
        ...
        self.save_button = tk.Button(self.button_frame, text=self.get_translation("save"), command=self.save_transaction)
        self.save_button.pack(side=tk.LEFT, padx=5)

        self.cancel_button = tk.Button(self.button_frame, text=self.get_translation("cancel"), command=self.destroy)
    ...
    def get_translation(self, key, **kwargs):
        return self.master.get_translation(key, **kwargs)